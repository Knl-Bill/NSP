    ...
    <div class="new-login-container">
        ...
        <div class="new-form-container"> 
            ...
            <form method="post" action="/StudentLoginVerify" id="signup">
                ...
                <div class="form-group">
                    <a href="{{ route('forget-password') }}" class="font loadspin" style="font-size:14px; text-decoration:none;">Forgot Password?</a>
                </div>
                <div class="form-group button">
                    <input class="submit-btn loadspin" type="submit" id="submit" value="Login">
                </div>
                <div class="text-below-image">Don't have an account? <a href="{{route('student_signup_request')}}" class="loadspin" style="text-decoration:none">Sign Up</a></div>
            </form>
        </div>
    </div>
    <script>
