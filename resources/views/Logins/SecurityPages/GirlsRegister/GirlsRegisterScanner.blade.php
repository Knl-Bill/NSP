...
<body>
        ...
        <div class="container-fluid custom-navbar">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav custom-nav-items">
              ...
              <li class="nav-item">
                <a class="nav-link profile-btn loadspin" href='{{route('SecurityProfile')}}'><i class="bi bi-person-fill custom-icon"></i></a>
              </li>
              <li class="nav-item">
    ...
    <div class="outing-container">
        <h1 class="heading font">Scan Barcode</h1>
        ...
        <div class="inputs" id="Interactive" class="viewport">
            ...
            <img src="" alt="Profile Image" id="ProfileImage" style="display:none; ">
        </div>
        <div id="ScannerMessage" style="color:green;" class="text-center"></div>
        <form id="scannerForm" method="POST" action="/GLHOuting">
            @csrf
            <div class="form-group">
                <input style="display: none;" type="text" name="rollno" id="rollnoInput">
            </div>
            <div class="form-group button">
                <button class="submit-btn loadspin" type="submit" id="submit">Submit</button>
            </div>
        </form>
    </div>
                        ...
                        codeReader.decodeFromVideoDevice(selectedDeviceId, 'video', (result, err) => {
                            if (!formSubmitted && result) {
                                ...
                                if (result.text.length === 9) { // assuming the roll no is 9 characters long
                                    ...
                                    let Profile = 'public/storage/profile/' + detectedRollNo + '.png';
                                    codeReader.reset();
                                    Image.src = Profile;
