...
<head>
    ...
    <title>Girls Register History</title>
    ...
    <link rel="stylesheet" href="assets/css/SecurityNewOutingHistory.css">
...
<body>
    ...
    <div class="container filter">
        ...
        <form method="GET" action="{{ route('GLHOutingStatus') }}">
        @elseif($Name === "Unclosed Outing")
        <form method="GET" action="{{ route('GLHUnclosedOuting') }}">
        @endif
            <div class="row mb-3">
                <div class="col">
        ...
        <div class="content">
            <table>
                ...
                <tbody>
                    ...
                    <tr class="FemaleRow"  @if($outing->late == 1) style="background-color: #ff4c4c; box-shadow: inset -3px -5px 10px #993333;" @endif>
                        <td>{{$outing->rollno}}</td>
