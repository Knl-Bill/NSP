...
<body>
    ...
    <div class="outing-container">
        ...
        <div class="form-container">
            <form action="/GLHOuting" method="POST">
                @csrf
